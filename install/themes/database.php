...
<?php } elseif ($type == '2') { ?>
	...
	<p><?php echo t('db_10'); ?></p>

	<form id="step-form">
		<fieldset>
			<div class="field">
				<label><input type="radio" name="update" value="101_110" checked="checked"><?php echo t('db_update_2'); ?></label>
				<label><input type="radio" name="update" value="100_101"><?php echo t('db_update_1'); ?></label>
			</div>
		</fieldset>
	</form>
