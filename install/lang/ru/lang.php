<?php
    ...
    */
    ...
    define('TEXT_WELCOME_STEP2','<b>Установка базы данных</b><br /><br />OSC-CMS автоматически установит базу данных магазина.');
    define('TEXT_WELCOME_STEP3','<b>Импорт базы данных.</b><br /><br />');
    define('TEXT_WELCOME_STEP3_1','<b>Импорт базы данных товаров.</b><br /><br />');
    define('TEXT_WELCOME_STEP4','<b>Настройка конфигурационных файлов OSC-CMS</b><br /><br /><b>Если есть старые конфигурационные файлы от предыдущих установок, OSC-CMS удалит их автоматически.</b><br /><br />Инсталлятор сконфигурирует основные параметры БД и структуру файлов.');
    ...
    ');
    define('TEXT_WELCOME_FINISHED','<b>Установка OSC-CMS успешно завершена!</b>');
    ...
    define('TEXT_BEGIN_CHECKING', 'Начальная проверка');
