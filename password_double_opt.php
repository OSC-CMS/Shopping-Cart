...
{
	$login = os_db_prepare_input($_POST['email']);

	$check_customer_query = os_db_query("select customers_email_address, customers_id, customers_telephone from ".TABLE_CUSTOMERS." where (customers_email_address = '".os_db_input($login)."' OR customers_telephone = '".os_db_input($login)."')");
