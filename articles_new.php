...
if ($articles_new_split->number_of_rows > 0) {
	...
	while ($articles_new = os_db_fetch_array($articles_new_query)) {
		...
		'ARTICLE_SHORT_DESCRIPTION' => $articles_new['articles_description_short'], 
