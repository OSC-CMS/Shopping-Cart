...
<table class="table table-striped table-condensed table-content well-table">
	...
	?>
		<tr>
			...
			<td width="140"><span class="pull-right"><?php echo $orders['orders_status_name']; ?></span></td>
			<td width="20"><div class="pull-right" style="margin-top:3px;width:15px;height:15px;background: <?php echo $orders['orders_status_color']; ?>;"></div></td>
		</tr>
	<?php } ?>
	</tbody>
</table>