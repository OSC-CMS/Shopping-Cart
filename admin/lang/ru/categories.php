...
define('TEXT_PRODUCTS_PRICE_CURRENCY_DESC', 'Цена будет автоматически пересчитана по курсу в валюту по умолчанию, если не выбрана опиця "Сохранить цену в выбранной валюте".');
define('TEXT_PRODUCTS_PRICE_CURRENCY_SAVE', 'Сохранить цену в выбранной валюте');
...
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Ошибка: Директория картинок закрыта на запись: ');
...
define('TXT_DATE_ADD','Дата добавления');
