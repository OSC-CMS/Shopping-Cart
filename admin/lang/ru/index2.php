...
*/
  ...
  define('TEXT_FOLDER_WARNING','<b class="red">Внимание:</b><br />Следующие папки закрыты от записи. Измените права доступа на эти папки. Например установите <b>777</b> для юникса, или <b>(read-write)</b> для Windows.');
