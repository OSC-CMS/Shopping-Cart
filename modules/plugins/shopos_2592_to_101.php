<?php
/*
	Plugin Name: Обновление БД с ShopOS 2.5.9.2 до 1.0.1
...
function shopos_2592_to_101_install()
{
	global $messageStack;

	os_db_query("INSERT INTO `".DB_PREFIX."configuration` VALUES('', 'TEMPLATE_COMPILE_CHECK', 'false', 11, 8, NULL, '0000-00-00 00:00:00', NULL, 'os_cfg_select_option(array(\'true\', \'false\'),');");
	...
	os_redirect(FILENAME_PLUGINS.'?module=shopos_2592_to_101');
}
?>