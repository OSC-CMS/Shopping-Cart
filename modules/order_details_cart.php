...
if ($_SESSION['cart']->count_contents() > 0) {
	...
	$osTemplate->assign('FORM_ACTION', os_draw_form('form_shopping_cart', os_href_link(FILENAME_SHOPPING_CART, 'action=update_product')));
...
for ($i = 0, $n = sizeof($products); $i < $n; $i ++) {
	...
	$module_content[$i] = array ('PRODUCTS_NAME' => $products[$i]['name'].$mark_stock, 
								 ...
								 $products[$i]['quantity'], 'onchange="updateShoppingCart()" class="sc_qty_'.$productIds.'"').os_draw_hidden_field('products_id[]', 
