...
*/
	...
	class russianpostpf extends  russianpostt{
		...
		function check()
		{
			...
			{
				$check_query = os_db_query("SELECT configuration_value FROM " . TABLE_CONFIGURATION . " WHERE configuration_key = 'MODULE_SHIPPING_RUSSIANPOSTPREPAY_PARCEL_STATUS_PF' || configuration_key = 'MODULE_SHIPPING_RUSSIANPOSTPREPAY_WRAPPER_STATUS_PF' LIMIT 1");
