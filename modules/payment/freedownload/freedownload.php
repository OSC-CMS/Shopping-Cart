...
class freedownload extends CartET
{
	/**
	...
	{
		return array(
			'MODULE_PAYMENT_FREEDOWNLOAD_STATUS',
			'MODULE_PAYMENT_FREEDOWNLOAD_ALLOWED',
			'MODULE_PAYMENT_FREEDOWNLOAD_ZONE',
			'MODULE_PAYMENT_FREEDOWNLOAD_ORDER_STATUS_ID',
			'MODULE_PAYMENT_FREEDOWNLOAD_SORT_ORDER'
		);
	}
}
?>