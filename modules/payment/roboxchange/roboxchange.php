...
if ($_SERVER["HTTP_X_FORWARDED_FOR"]) {
    ...
    function process_button() {
      ...
      $process_button_string = os_draw_hidden_field('InvId', substr($_SESSION['cart_roboxchange_id'], strpos($_SESSION['cart_roboxchange_id'], '-')+1)) .
                               os_draw_hidden_field('MrchLogin', MODULE_PAYMENT_ROBOXCHANGE_LOGIN) .
                               os_draw_hidden_field('Desc', substr($_SESSION['cart_roboxchange_id'], strpos($_SESSION['cart_roboxchange_id'], '-')+1)) .
