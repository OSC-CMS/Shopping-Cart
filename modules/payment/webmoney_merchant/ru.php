...
define('MODULE_PAYMENT_WEBMONEY_MERCHANT_TEXT_ADMIN_DESCRIPTION', 'Модуль оплаты WebMoney Merchant.<br /><br /><b>Как правильно настроить модули: <a href="http://osc-cms.com/docs" target="_blank"><u>здесь</u></a>.</b>');
...
define('MODULE_PAYMENT_WEBMONEYMERCHANT_TEXT_WMU','WMU');
define('MODULE_PAYMENT_WEBMONEYMERCHANT_TEXT_WMB','WMB');
define('MODULE_PAYMENT_WEBMONEYMERCHANT_TEXT_UAH','UAH');
...
define('MODULE_PAYMENT_WEBMONEY_MERCHANT_WMU_TITLE' , 'Ваш WMU кошелёк:');
define('MODULE_PAYMENT_WEBMONEY_MERCHANT_WMU_DESC' , 'Укажите номер Вашего WMU кошелька');
define('MODULE_PAYMENT_WEBMONEY_MERCHANT_WMB_TITLE' , 'Ваш WMB кошелёк:');
define('MODULE_PAYMENT_WEBMONEY_MERCHANT_WMB_DESC' , 'Укажите номер Вашего WMB кошелька');
define('MODULE_PAYMENT_WEBMONEY_MERCHANT_UAH_TITLE' , 'Ваш UAH кошелёк:');
define('MODULE_PAYMENT_WEBMONEY_MERCHANT_UAH_DESC' , 'Укажите номер Вашего UAH кошелька');
